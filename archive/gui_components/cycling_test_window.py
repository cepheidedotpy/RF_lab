...
from gui_components.gui_utils import add_label_frame, add_button, add_label, add_entry, add_Checkbutton, create_canvas, \
    tab_pad_x, \
    default_style
...
class CyclingTestWindow(ttk.Frame):
    def __init__(self, master, app: "Window"):
        ...
        add_button(tab=frame_cycling_comp_info, button_name="Stop Cycling",
                   ...
                   col=0, row=9).grid(ipadx=tab_pad_x, ipady=tab_pad_x)
        ...
        add_button(tab=frame_signal_generator, button_name='1kHz-1000pulses\n100us-5%',
                   command=lambda: [scripts_and_functions.load_pattern(
                       r"1000pulses_100us_pulse_dc5_36Vtop40V_triangle.arb")], col=0,
                   row=3).grid(
            ipadx=tab_pad_x, ipady=tab_pad_x)
        add_button(tab=frame_signal_generator, button_name='2kHz-1000pulses\n100us-10%',
                   command=lambda: [scripts_and_functions.load_pattern(
                       r"1000pulses_100us_pulse_dc10_36Vtop40V_triangle.arb")], col=1,
                   row=3).grid(
            ipadx=tab_pad_x, ipady=tab_pad_x)
        add_button(tab=frame_signal_generator, button_name='4kHz-1000pulses\n100us-20%',
                   command=lambda: [scripts_and_functions.load_pattern(
                       r"1000pulses_100us_pulse_dc10_36Vtop40V_triangle.arb")], col=2,
                   row=3).grid(
            ipadx=tab_pad_x, ipady=tab_pad_x)
